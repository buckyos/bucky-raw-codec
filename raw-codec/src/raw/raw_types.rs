...
impl VarSizeHelper {
    fn raw_measure(len: u64, _purpose: &Option<RawEncodePurpose>) -> CodecResult<usize> {
        let bytes;
    ...
    fn raw_decode(buf: &[u8]) -> CodecResult<(u64, &[u8])> {
